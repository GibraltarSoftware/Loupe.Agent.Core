...
namespace Loupe.Agent.Metrics
{
    ...
    {
        private readonly Core.Metrics.EventMetric m_WrappedMetric;
        ...
        internal EventMetric(EventMetricDefinition definition, string instanceName)
            : this(definition, new Core.Metrics.EventMetric(definition.WrappedDefinition, instanceName))
        {
        ...
        internal EventMetric(EventMetricDefinition definition, Core.Metrics.EventMetric metric)
        {
        ...
        /// </summary>
        internal Core.Metrics.EventMetric WrappedMetric { get { return m_WrappedMetric; } }
