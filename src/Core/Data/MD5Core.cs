...
namespace Loupe.Data
{
    ...
    public static class MD5Core
    {
        ...
        public static byte[] GetHash(string input, Encoding encoding)
        {
            ...
            if (null == encoding)
                throw new System.ArgumentNullException(nameof(encoding), "Unable to calculate hash over a string without a default encoding. Consider using the GetHash(string) overload to use UTF8 Encoding");
        ...
        */
        ...
        {
            if (null == input)
                throw new System.ArgumentNullException(nameof(input), "Unable convert null array to array of uInts");
