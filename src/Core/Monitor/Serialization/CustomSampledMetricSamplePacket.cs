...
namespace Loupe.Monitor.Serialization
{
    ...
    public class CustomSampledMetricSamplePacket : SampledMetricSamplePacket, IPacket, IPacketObjectFactory<MetricSample, Metric>, IComparable<CustomSampledMetricSamplePacket>, IEquatable<CustomSampledMetricSamplePacket>
    {
        ...
        {
            const string typeName = nameof(CustomSampledMetricSamplePacket);
