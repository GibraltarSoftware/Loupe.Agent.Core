...
namespace Gibraltar.Monitor.Internal
{
    ...
    /// </summary>
    internal sealed class EventMetricDefinitionPacket : MetricDefinitionPacket, ICachedPacket, IPacketObjectFactory<MetricDefinition, MetricDefinitionCollection>, IComparable<EventMetricDefinitionPacket>, IEquatable<EventMetricDefinitionPacket>
    {
        ...
        {
            var typeName = typeof(EventMetricDefinitionPacket).Name;
