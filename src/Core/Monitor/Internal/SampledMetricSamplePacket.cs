...
namespace Gibraltar.Monitor.Internal
{
    ...
    internal abstract class SampledMetricSamplePacket : MetricSamplePacket, IPacket, IComparable<SampledMetricSamplePacket>, IEquatable<SampledMetricSamplePacket>
    {
