...
namespace Gibraltar.Monitor.Internal
{
    ...
    /// </summary>
    internal abstract class SampledMetricDefinitionPacket : MetricDefinitionPacket, IPacket, IComparable<SampledMetricDefinitionPacket>, IEquatable<SampledMetricDefinitionPacket>
    {
        ...
        {
            var typeName = typeof(SampledMetricDefinitionPacket).Name;
