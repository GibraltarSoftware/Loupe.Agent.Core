...
namespace Gibraltar.Monitor.Internal
{
    ...
    /// </summary>
    internal abstract class MetricPacket : GibraltarCachedPacket, IPacket, IPacketObjectFactory<Metric, MetricDefinition>, IComparable<MetricPacket>, IEquatable<MetricPacket>, IDisplayable
    {
