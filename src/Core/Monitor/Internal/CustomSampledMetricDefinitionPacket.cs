...
namespace Gibraltar.Monitor.Internal
{
    ...
    /// </summary>
    internal class CustomSampledMetricDefinitionPacket : SampledMetricDefinitionPacket, IPacket, IPacketObjectFactory<MetricDefinition, MetricDefinitionCollection>, IComparable<CustomSampledMetricDefinitionPacket>, IEquatable<CustomSampledMetricDefinitionPacket>
    {
