...
namespace Gibraltar.Monitor.Internal
{
    ...
    internal abstract class MetricSamplePacket : GibraltarPacket, IPacket, IPacketObjectFactory<MetricSample, Metric>, IComparable<MetricSamplePacket>, IEquatable<MetricSamplePacket>, IDisplayable
    {
