...
namespace Gibraltar.Monitor.Internal
{
    ...
    /// </summary>
    internal class EventMetricValueDefinitionPacket : GibraltarCachedPacket, ICachedPacket, IEquatable<EventMetricValueDefinitionPacket>, IDisplayable
    {
        ...
        {
            var typeName = typeof(EventMetricValueDefinitionPacket).Name;
