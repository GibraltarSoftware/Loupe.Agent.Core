...
namespace Gibraltar.Monitor.Internal
{
    ...
    /// </summary>
    internal class MetricDefinitionPacket : GibraltarCachedPacket, IPacket, IPacketObjectFactory<MetricDefinition, MetricDefinitionCollection>, IComparable<MetricDefinitionPacket>, IEquatable<MetricDefinitionPacket>, IDisplayable
    {
        /// <summary>
        ...
        {
            var typeName = typeof(MetricDefinitionPacket).Name;
