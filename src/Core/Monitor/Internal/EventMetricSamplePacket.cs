...
namespace Gibraltar.Monitor.Internal
{
    ...
    internal class EventMetricSamplePacket : MetricSamplePacket, IDynamicPacket, IPacketObjectFactory<MetricSample, Metric>, IComparable<EventMetricSamplePacket>, IEquatable<EventMetricSamplePacket>
    {
