...
namespace Loupe.Agent.PerformanceCounters.Serialization
{
    ...
    /// </summary>
    /// <remarks>This is copied from the .NET source code because it is not available on non-windows platforms there.</remarks>
    public readonly struct SerializedCounterSample : IEquatable<SerializedCounterSample>
    {
        ...
        public static SerializedCounterSample Empty = new SerializedCounterSample(0, 0, 0, 0, 0, 0, PerformanceCounterType.NumberOfItems32);

        public SerializedCounterSample(long rawValue, long baseValue, long counterFrequency, long systemFrequency, long timeStamp, long timeStamp100nSec, PerformanceCounterType counterType)
        {
            _rawValue = rawValue;
        ...
        public SerializedCounterSample(long rawValue, long baseValue, long counterFrequency, long systemFrequency, long timeStamp, long timeStamp100nSec, PerformanceCounterType counterType, long counterTimeStamp)
        {
            _rawValue = rawValue;
            _baseValue = baseValue;
            _timeStamp = timeStamp;
        ...
        {
            return (o is SerializedCounterSample) && Equals((SerializedCounterSample)o);
        }

        public bool Equals(SerializedCounterSample sample)
        {
        ...
        public static bool operator ==(SerializedCounterSample a, SerializedCounterSample b)
        {
            return a.Equals(b);
        }
